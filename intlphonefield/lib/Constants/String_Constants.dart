...
const String accountTypeConst = "accountType";
const String bankNameConst = "bankName";
...
const String phoneRegExpConst = r"[0-9]";
const String passwordRegExpConst = r'^(?=.*?[A-Z])(?=.*?[a-z])(?=.*?[0-9])(?=.*?[!@#\><*~]).{8,}/pre>';